...
pma = 700
prod_leche_total = 0
print("INICIO DEL SCRIPT - HILO 1 ///////////////////////////////////////////////////////////")
print("/////////////////////////////////////////////////////////////////////////////////////")
print("/////////////////////////////////////////////////////////////////////////////////////")
...
##algoritmo de ordenamiento, tipo lambda
print("///////////////////////////////////////////////////////////")
print("///////////////////////////////////////////////////////////")
print("HILO 1 - ///////////////////////////////////////////////////////////")
print("Ordenamos el array en función del INDICE GLOBAL: ")
lista_elegidas = []
def fifthItem(ls):
    return ls[5]
...
while x < 700:
	...
	if x < 700:
			...
			#print("Peso acumulado al camión: ", x)
			i += 1
	elif x > 700:
			print("DESCARTADO el candidato:", vacas[i][0], " y su peso: ", vacas[i][1]); i += 1
...
val = input("Esta solución puede no ser la óptima, ¿probamos con otra posibilidad no explorada? (responde SI o NO): ") 
print(val)
if val== "SI":
    import solucion_vacas_solucion_ingenua_hilo2